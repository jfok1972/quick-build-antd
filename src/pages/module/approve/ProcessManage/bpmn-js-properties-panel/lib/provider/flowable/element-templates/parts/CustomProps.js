...
var FLOWABLE_PROPERTY_TYPE = 'activiti:property',
    FLOWABLE_INPUT_PARAMETER_TYPE = 'activiti:inputParameter',
    FLOWABLE_OUTPUT_PARAMETER_TYPE = 'activiti:outputParameter',
    FLOWABLE_IN_TYPE = 'activiti:in',
    FLOWABLE_OUT_TYPE = 'activiti:out',
    FLOWABLE_IN_BUSINESS_KEY_TYPE = 'activiti:in:businessKey',
    FLOWABLE_EXECUTION_LISTENER_TYPE = 'activiti:executionListener',
    FLOWABLE_FIELD = 'activiti:field';
...
function getPropertyValue(element, property) {
  ...
  if (bindingType === FLOWABLE_PROPERTY_TYPE) {
    if (scope) {
      ...
      flowableProperties = findExtension(bo, 'activiti:Properties');
    }
...
function setPropertyValue(element, property, value, bpmnFactory) {
  ...
  if (bindingType === FLOWABLE_PROPERTY_TYPE) {
    ...
    if (scope) {
      ...
      flowableProperties = findExtension(extensionElements, 'activiti:Properties');
    }

    if (!flowableProperties) {
      flowableProperties = elementHelper.createElement('activiti:Properties', null, bo, bpmnFactory);
