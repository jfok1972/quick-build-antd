export default {
  ...
  'user-login.login.message-invalid-code-2': '用户名或密码错误',
  'user-login.login.message-invalid-code-3': '用户名或密码错误',
  'user-login.login.message-invalid-code-1': '验证码错误',
  'user-login.login.message-invalid-code-4': '当前用户已被锁定',
  'user-login.login.message-invalid-code-5': '人员或用户未启用或已失效',
  ...
  'user-login.login.message-invalid-code-9': '用户密码解析错误，请刷新网页后重新登录',
  'user-login.login.message-invalidate-title': '确定强制登录',
  'user-login.login.message-invalidate':
    '用户已在其他终端登录，本登录成功后该终端用户会被注销，确定登录吗？',
